const CACHE_NAME = "spt-pro-v38.2-stable";
const CORE_ASSETS = ["./", "./index.html", "./style.css", "./main-v38-2.css", "./main-v38-2.js", "./script.js", "./manifest.webmanifest", "./offline.html", "./icon-192.png", "./icon-512.png"];
